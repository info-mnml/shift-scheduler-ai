...
const Dashboard = ({ currentStep, onNext }) => {
  const [notifications, setNotifications] = useState([
    { id: 1, type: 'info', message: 'システムメンテナンスは9/30 2:00-4:00に実施予定です', time: '2時間前' },
    ...
    >
          ...
          <Card className="shadow-lg border-0">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={currentStep >= 2 ? "default" : "secondary"} className="bg-green-100 text-green-800">
                  {currentStep >= 2 ? "完了" : "待機中"}
                </Badge>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`w-2 h-2 rounded-full mr-3 ${currentStep >= 3 ? 'bg-green-500' : 'bg-gray-300'}`}></div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`w-2 h-2 rounded-full mr-3 ${currentStep >= 6 ? 'bg-green-500' : 'bg-gray-300'}`}></div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`w-2 h-2 rounded-full mr-3 ${currentStep >= 9 ? 'bg-green-500' : 'bg-gray-300'}`}></div>
      ...
      <div className="mt-8 flex justify-end">
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button onClick={onNext} size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg">
            次のステップへ
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium ml-2 text-green-600">{validationResults?.validRows}行</span>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600 mb-1">{validationResults.validRows}</div>
                  <div className="text-sm text-green-700">有効データ</div>
                </div>
                <div className="text-center p-4 bg-yellow-50 rounded-lg">
                  <div className="text-2xl font-bold text-yellow-600 mb-1">{validationResults.warnings}</div>
                  <div className="text-sm text-yellow-700">警告</div>
                </div>
                <div className="text-center p-4 bg-red-50 rounded-lg">
                  <div className="text-2xl font-bold text-red-600 mb-1">{validationResults.errors}</div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <div className="flex items-center p-3 bg-green-50 rounded-lg">
                  <CheckCircle className="h-5 w-5 text-green-600 mr-3" />
                  <span className="text-sm font-medium text-green-800">データ行数: {validationResults.totalRows}名分</span>
                </div>
                <div className="flex items-center p-3 bg-yellow-50 rounded-lg">
                  <AlertTriangle className="h-5 w-5 text-yellow-600 mr-3" />
                  <span className="text-sm font-medium text-yellow-800">スキル列欠落: 2名（自動補完予定）</span>
                </div>
              </div>
            </CardContent>
          </Card>
...
const FirstPlan = ({ onNext, onPrev }) => {
  ...
  const shiftData = [
    ...
    { date: 2, shifts: [{ name: '佐藤', time: '13-21', skill: 5 }, { name: '山田', time: '9-15', skill: 3 }] },
    { date: 3, shifts: [{ name: '鈴木', time: '10-18', skill: 4 }] },
    { date: 4, shifts: [{ name: '田中', time: '9-17', skill: 4 }, { name: '佐藤', time: '17-21', skill: 5 }] },
    { date: 5, shifts: [{ name: '山田', time: '9-15', skill: 3 }, { name: '高橋', time: '15-21', skill: 4 }] },
    { date: 6, shifts: [{ name: '佐藤', time: '10-18', skill: 5 }, { name: '田中', time: '18-22', skill: 4 }] },
    { date: 7, shifts: [{ name: '鈴木', time: '9-17', skill: 4 }, { name: '山田', time: '17-21', skill: 3 }] },
    { date: 8, shifts: [{ name: '高橋', time: '9-15', skill: 4 }] },
    { date: 9, shifts: [{ name: '田中', time: '13-21', skill: 4 }, { name: '佐藤', time: '9-13', skill: 5 }] },
    { date: 10, shifts: [{ name: '山田', time: '10-18', skill: 3 }] },
    { date: 11, shifts: [{ name: '鈴木', time: '9-17', skill: 4 }, { name: '高橋', time: '17-21', skill: 4 }] },
    { date: 12, shifts: [{ name: '佐藤', time: '9-15', skill: 5 }, { name: '田中', time: '15-21', skill: 4 }] },
    { date: 13, shifts: [{ name: '山田', time: '10-18', skill: 3 }, { name: '鈴木', time: '18-22', skill: 4 }] },
    { date: 14, shifts: [{ name: '高橋', time: '9-17', skill: 4 }, { name: '佐藤', time: '17-21', skill: 5 }] },
    { date: 15, shifts: [{ name: '田中', time: '9-15', skill: 4 }] },
    { date: 16, shifts: [{ name: '山田', time: '13-21', skill: 3 }, { name: '鈴木', time: '9-13', skill: 4 }] },
    { date: 17, shifts: [{ name: '佐藤', time: '10-18', skill: 5 }] },
    { date: 18, shifts: [{ name: '高橋', time: '9-17', skill: 4 }, { name: '田中', time: '17-21', skill: 4 }] },
    { date: 19, shifts: [{ name: '鈴木', time: '9-15', skill: 4 }, { name: '山田', time: '15-21', skill: 3 }] },
    { date: 20, shifts: [{ name: '佐藤', time: '10-18', skill: 5 }, { name: '高橋', time: '18-22', skill: 4 }] },
    { date: 21, shifts: [{ name: '田中', time: '9-17', skill: 4 }, { name: '鈴木', time: '17-21', skill: 4 }] },
    { date: 22, shifts: [{ name: '山田', time: '9-15', skill: 3 }] },
    { date: 23, shifts: [{ name: '佐藤', time: '13-21', skill: 5 }, { name: '高橋', time: '9-13', skill: 4 }] },
    { date: 24, shifts: [{ name: '田中', time: '10-18', skill: 4 }] },
    { date: 25, shifts: [{ name: '鈴木', time: '9-17', skill: 4 }, { name: '山田', time: '17-21', skill: 3 }] },
    { date: 26, shifts: [{ name: '佐藤', time: '9-15', skill: 5 }, { name: '高橋', time: '15-21', skill: 4 }] },
    { date: 27, shifts: [{ name: '田中', time: '10-18', skill: 4 }, { name: '鈴木', time: '18-22', skill: 4 }] },
    { date: 28, shifts: [{ name: '山田', time: '9-17', skill: 3 }, { name: '佐藤', time: '17-21', skill: 5 }] },
    { date: 29, shifts: [{ name: '高橋', time: '9-15', skill: 4 }] },
    { date: 30, shifts: [{ name: '田中', time: '13-21', skill: 4 }, { name: '鈴木', time: '9-13', skill: 4 }] }
  ]
                ...
                >
                  <div className="grid grid-cols-7 gap-2 mb-4">
                    {['日', '月', '火', '水', '木', '金', '土'].map(day => (
                      <div key={day} className="p-3 text-center font-bold bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                        {day}
                      </div>
                    ))}
                  </div>
            ...
            {staffStatus.map(staff => (
              <div key={staff.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-4">
                  <div className={`w-3 h-3 rounded-full ${staff.submitted ? 'bg-green-500' : 'bg-red-500'}`} />
                  <div>
        ...
        <div className="space-y-8">
          ...
          <Card className="shadow-lg border-0">
            ...
            <CardContent>
              <div className="grid grid-cols-7 gap-2 mb-4">
                {['日', '月', '火', '水', '木', '金', '土'].map(day => (
                  <div key={day} className="p-3 text-center font-bold bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg">
                    {day}
                  </div>
                ))}
              </div>
                      ...
                      {dayData?.shifts.map((shift, idx) => (
                        ...
                        >
                          <div className="font-medium flex items-center">
                            {shift.name}
                            {shift.preferred && <CheckCircle className="h-3 w-3 ml-1 text-green-600" />}
                          </div>
                          <div className="text-xs opacity-80">{shift.time}</div>
                        </motion.div>
                      ))}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <Card className="shadow-lg border-0 xl:col-span-2">
          ...
          <CardContent>
            <div className="grid grid-cols-7 gap-2 mb-4">
              {['日', '月', '火', '水', '木', '金', '土'].map(day => (
                <div key={day} className="p-2 text-center font-bold bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg text-sm">
                  {day}
                </div>
              ))}
            </div>
...
const HistoryAudit = ({ onPrev }) => {
  ...
  const [auditLogs, setAuditLogs] = useState([
    { id: 1, timestamp: '2024-09-18 14:32', user: '管理者', action: 'シフト確定', details: '9月第1週シフトを確定・配布', status: 'success' },
    { id: 2, timestamp: '2024-09-18 14:30', user: 'AI', action: 'チャット修正', details: '田中太郎の土曜シフトを午後に変更', status: 'success' },
    { id: 3, timestamp: '2024-09-18 14:15', user: 'AI', action: '第2案生成', details: 'スタッフ希望を反映した最適化完了', status: 'success' },
    { id: 4, timestamp: '2024-09-17 16:45', user: '管理者', action: '希望回収締切', details: '希望回収を締切、5名中5名提出完了', status: 'success' },
    { id: 5, timestamp: '2024-09-15 10:00', user: '管理者', action: '希望回収開始', details: '希望入力リンクを全スタッフに配布', status: 'success' }
  ])

  const [shiftHistory, setShiftHistory] = useState([
    { period: '2024年9月第1週', status: '確定済み', satisfaction: 89, coverage: 92, cost: 48000, date: '2024-09-18' },
    { period: '2024年8月第4週', status: '完了', satisfaction: 85, coverage: 88, cost: 52000, date: '2024-08-25' },
    { period: '2024年8月第3週', status: '完了', satisfaction: 82, coverage: 90, cost: 49000, date: '2024-08-18' }
  ])
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <label key={period.id} className="flex items-center space-x-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    type="radio"
                    name="period"
                    value={period.id}
