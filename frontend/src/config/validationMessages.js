...
export const ERROR_MESSAGES = {
  ...
  VAL003: {
    code: 'VAL003',
    category: '法令',
    template: '{workHours}時間超の勤務には{requiredBreak}分以上の休憩が必要です（現在: {actualBreak}分）',
  ...
  VAL013: {
    code: 'VAL013',
    category: 'スキル',
    template: '必要スキルレベルを満たしていません（{position}: レベル{required}必要、現在: {current}）',
    lawReference: null,
    level: 'WARNING',
    autoAction: 'スタッフ変更提案'
  },
  VAL014: {
    code: 'VAL014',
    category: 'スキル',
    template: '役割バランスが適切ではありません（調理: {cooking}名、ホール: {hall}名、レジ: {cashier}名）',
    lawReference: null,
    level: 'WARNING',
    autoAction: '配置提案'
  },
  ...
  LAW_007: {
    code: 'LAW_007',
    category: '法令',
    template: '18歳未満のスタッフ「{staffName}」は1日8時間を超えて勤務できません（現在: {hours}時間）',
  ...
  LM004: {
    code: 'LM004',
    category: '健康管理',
    template: '連続勤務日数が推奨上限を超えています（{consecutiveDays}日連続、推奨: {recommendedMax}日以下）',
    level: 'WARNING'
  },
  LM005: {
    code: 'LM005',
  ...
  LM009: {
    code: 'LM009',
    category: 'スキル',
    template: '新人スタッフ「{staffName}」の単独勤務は禁止されています（入社{months}ヶ月、制限: 3ヶ月）',
    level: 'ERROR'
  },
  LM010: {
    code: 'LM010',
